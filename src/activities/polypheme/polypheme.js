            ...
            <Container kind='view' width='600px' {...this.link ()} >
              ...
              <Container kind='panes' {...this.link ()} >
                ...
                <Container kind='pane' {...this.link ()} >
                  ...
                  <Container kind='row-pane' subkind='box' {...this.link ()} >
                    <Label glyph='bookmark' glyph-color='#ff0000' {...this.link ()} />
                  ...
                  <Container kind='row-pane' subkind='box' {...this.link ()} >
                    <Label glyph='bookmark' glyph-color='#2e5588' {...this.link ()} />
                    <Label text='Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.' wrap='no' grow='1' {...this.link ()} />
                    <Button glyph='trash-o' shape='left-smooth' spacing='overlap' {...this.link ()} />
                    <Button glyph='pencil' shape='right-smooth' {...this.link ()} />
                  </Container>
                  <Container kind='row-pane' subkind='box' {...this.link ()} >
                    <Label glyph='bookmark' glyph-color='#ffaf00' {...this.link ()} />
                    <Label text='Lorem ipsum dolor sit amet' grow='1' {...this.link ()} />
                    <Button glyph='trash-o' shape='left-smooth' spacing='overlap' {...this.link ()} />
                    <Button glyph='pencil' shape='right-smooth' {...this.link ()} />
                  </Container>
                  <Container kind='row-pane' subkind='box' {...this.link ()} >
                    <Label glyph='bookmark' glyph-color='#2e5588' {...this.link ()} />
                    <Label text='Lorem ipsum dolor sit amet, consectetur adipiscing elit' grow='1' {...this.link ()} />
                    <Button glyph='trash-o' shape='left-smooth' spacing='overlap' {...this.link ()} />
                    <Button glyph='pencil' shape='right-smooth' {...this.link ()} />
                  </Container>
