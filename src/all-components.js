...
import _DispatchMessengers$connected from './components/dispatch-messengers.connected.js';
...
export const DispatchMessengers = Electrum.wrap ('DispatchMessengers', _DispatchMessengers, {connected: _DispatchMessengers$connected});
