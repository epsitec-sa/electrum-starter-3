...
import _Backlog from './components/backlog.component.js';
...
import _Desk from './components/desk.component.js';
...
export const Backlog = Electrum.wrap ('Backlog', _Backlog);
...
export const Desk = Electrum.wrap ('Desk', _Desk);
