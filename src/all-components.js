...
import _DispatchJobs from './components/dispatch-jobs.component.js';
import _DispatchRunners from './components/dispatch-runners.component.js';
...
export const DispatchJobs = Electrum.wrap ('DispatchJobs', _DispatchJobs);
export const DispatchRunners = Electrum.wrap ('DispatchRunners', _DispatchRunners);
